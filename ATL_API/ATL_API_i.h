...
#ifndef __ATL_API_i_h__
#define __ATL_API_i_h__
...
#ifndef __IAPI_COM_FWD_DEFINED__
#define __IAPI_COM_FWD_DEFINED__
typedef interface IAPI_COM IAPI_COM;

#endif 	/* __IAPI_COM_FWD_DEFINED__ */
...
#ifndef ___IAPI_COMEvents_FWD_DEFINED__
#define ___IAPI_COMEvents_FWD_DEFINED__
typedef interface _IAPI_COMEvents _IAPI_COMEvents;

#endif 	/* ___IAPI_COMEvents_FWD_DEFINED__ */


#ifndef __API_COM_FWD_DEFINED__
#define __API_COM_FWD_DEFINED__

#ifdef __cplusplus
typedef class API_COM API_COM;
#else
typedef struct API_COM API_COM;
#endif /* __cplusplus */

#endif 	/* __API_COM_FWD_DEFINED__ */
...
#ifndef __IAPI_COM_INTERFACE_DEFINED__
#define __IAPI_COM_INTERFACE_DEFINED__

/* interface IAPI_COM */
/* [unique][nonextensible][dual][uuid][object] */ 


EXTERN_C const IID IID_IAPI_COM;

#if defined(__cplusplus) && !defined(CINTERFACE)
    
    MIDL_INTERFACE("66C5FCF9-15B3-47BE-99DE-E6C676694561")
    IAPI_COM : public IDispatch
    {
    public:
    ...
    interface IAPI_COM
    {
        CONST_VTBL struct IAPI_COMVtbl *lpVtbl;
    };
...
#define IAPI_COM_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define IAPI_COM_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define IAPI_COM_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define IAPI_COM_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define IAPI_COM_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define IAPI_COM_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define IAPI_COM_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 


#define IAPI_COM_Add(This,argv1,argv2,retval)	\
    ( (This)->lpVtbl -> Add(This,argv1,argv2,retval) ) 
...
#endif 	/* __IAPI_COM_INTERFACE_DEFINED__ */



#ifndef __ATL_APILib_LIBRARY_DEFINED__
#define __ATL_APILib_LIBRARY_DEFINED__

/* library ATL_APILib */
/* [custom][version][uuid] */ 


EXTERN_C const IID LIBID_ATL_APILib;

EXTERN_C const CLSID CLSID_CompReg;

#ifdef __cplusplus

class DECLSPEC_UUID("47107176-F049-4BDC-861B-824F4694EECC")
CompReg;
#endif

#ifndef ___IAPI_COMEvents_DISPINTERFACE_DEFINED__
#define ___IAPI_COMEvents_DISPINTERFACE_DEFINED__

/* dispinterface _IAPI_COMEvents */
/* [uuid] */ 


EXTERN_C const IID DIID__IAPI_COMEvents;

#if defined(__cplusplus) && !defined(CINTERFACE)

    MIDL_INTERFACE("950209E1-669C-4D49-B7AC-B9CF5C08A529")
    _IAPI_COMEvents : public IDispatch
    {
    };
    
#else 	/* C style interface */

    typedef struct _IAPI_COMEventsVtbl
    {
        BEGIN_INTERFACE
        
        HRESULT ( STDMETHODCALLTYPE *QueryInterface )( 
            _IAPI_COMEvents * This,
            /* [in] */ REFIID riid,
            /* [annotation][iid_is][out] */ 
            _COM_Outptr_  void **ppvObject);
    ...
    interface _IAPI_COMEvents
    {
        CONST_VTBL struct _IAPI_COMEventsVtbl *lpVtbl;
    };
...
#define _IAPI_COMEvents_QueryInterface(This,riid,ppvObject)	\
    ( (This)->lpVtbl -> QueryInterface(This,riid,ppvObject) ) 

#define _IAPI_COMEvents_AddRef(This)	\
    ( (This)->lpVtbl -> AddRef(This) ) 

#define _IAPI_COMEvents_Release(This)	\
    ( (This)->lpVtbl -> Release(This) ) 


#define _IAPI_COMEvents_GetTypeInfoCount(This,pctinfo)	\
    ( (This)->lpVtbl -> GetTypeInfoCount(This,pctinfo) ) 

#define _IAPI_COMEvents_GetTypeInfo(This,iTInfo,lcid,ppTInfo)	\
    ( (This)->lpVtbl -> GetTypeInfo(This,iTInfo,lcid,ppTInfo) ) 

#define _IAPI_COMEvents_GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId)	\
    ( (This)->lpVtbl -> GetIDsOfNames(This,riid,rgszNames,cNames,lcid,rgDispId) ) 

#define _IAPI_COMEvents_Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr)	\
    ( (This)->lpVtbl -> Invoke(This,dispIdMember,riid,lcid,wFlags,pDispParams,pVarResult,pExcepInfo,puArgErr) ) 
...
#endif 	/* ___IAPI_COMEvents_DISPINTERFACE_DEFINED__ */


EXTERN_C const CLSID CLSID_API_COM;

#ifdef __cplusplus

class DECLSPEC_UUID("CD830E3F-52E6-4DEC-9808-ABEA2D39231E")
API_COM;
#endif
#endif /* __ATL_APILib_LIBRARY_DEFINED__ */
