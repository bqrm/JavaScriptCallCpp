...
typedef struct _ATL_API_MIDL_TYPE_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ TYPE_FORMAT_STRING_SIZE ];
    } ATL_API_MIDL_TYPE_FORMAT_STRING;

typedef struct _ATL_API_MIDL_PROC_FORMAT_STRING
    {
    short          Pad;
    unsigned char  Format[ PROC_FORMAT_STRING_SIZE ];
    } ATL_API_MIDL_PROC_FORMAT_STRING;

typedef struct _ATL_API_MIDL_EXPR_FORMAT_STRING
    {
    long          Pad;
    unsigned char  Format[ EXPR_FORMAT_STRING_SIZE ];
    } ATL_API_MIDL_EXPR_FORMAT_STRING;
...
extern const ATL_API_MIDL_TYPE_FORMAT_STRING ATL_API__MIDL_TypeFormatString;
extern const ATL_API_MIDL_PROC_FORMAT_STRING ATL_API__MIDL_ProcFormatString;
extern const ATL_API_MIDL_EXPR_FORMAT_STRING ATL_API__MIDL_ExprFormatString;
...
extern const MIDL_SERVER_INFO IAPI_COM_ServerInfo;
extern const MIDL_STUBLESS_PROXY_INFO IAPI_COM_ProxyInfo;
...
static const ATL_API_MIDL_PROC_FORMAT_STRING ATL_API__MIDL_ProcFormatString =
    {
        0,
        {
...
static const ATL_API_MIDL_TYPE_FORMAT_STRING ATL_API__MIDL_TypeFormatString =
    {
        0,
        {
			NdrFcShort( 0x0 ),	/* 0 */
...
static const MIDL_STUBLESS_PROXY_INFO IComponentRegistrar_ProxyInfo =
    {
    &Object_StubDesc,
    ATL_API__MIDL_ProcFormatString.Format,
...
/* Object interface: IAPI_COM, ver. 0.0,
   GUID={0x66C5FCF9,0x15B3,0x47BE,{0x99,0xDE,0xE6,0xC6,0x76,0x69,0x45,0x61}} */

#pragma code_seg(".orpc")
static const unsigned short IAPI_COM_FormatStringOffsetTable[] =
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_STUBLESS_PROXY_INFO IAPI_COM_ProxyInfo =
    {
    &Object_StubDesc,
    ATL_API__MIDL_ProcFormatString.Format,
    &IAPI_COM_FormatStringOffsetTable[-3],
    0,
    0,
    0
    };
...
static const MIDL_SERVER_INFO IAPI_COM_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    ATL_API__MIDL_ProcFormatString.Format,
    ...
    0,
    0};
CINTERFACE_PROXY_VTABLE(8) _IAPI_COMProxyVtbl = 
{
    &IAPI_COM_ProxyInfo,
    &IID_IAPI_COM,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *) (INT_PTR) -1 /* IAPI_COM::Add */
};


static const PRPC_STUB_FUNCTION IAPI_COM_table[] =
{
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
    STUB_FORWARDING_FUNCTION,
...
CInterfaceStubVtbl _IAPI_COMStubVtbl =
{
    &IID_IAPI_COM,
    &IAPI_COM_ServerInfo,
    8,
...
static const MIDL_STUB_DESC Object_StubDesc = 
    ...
    0,
    0,
    ATL_API__MIDL_TypeFormatString.Format,
...
const CInterfaceProxyVtbl * const _ATL_API_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IComponentRegistrarProxyVtbl,
    ( CInterfaceProxyVtbl *) &_IAPI_COMProxyVtbl,
    0
};

const CInterfaceStubVtbl * const _ATL_API_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IComponentRegistrarStubVtbl,
    ( CInterfaceStubVtbl *) &_IAPI_COMStubVtbl,
    0
...
PCInterfaceName const _ATL_API_InterfaceNamesList[] = 
{
    "IComponentRegistrar",
    "IAPI_COM",
    0
...
const IID *  const _ATL_API_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _ATL_API_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _ATL_API, pIID, n)

int __stdcall _ATL_API_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _ATL_API, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _ATL_API, 2, *pIndex )
    
}

const ExtendedProxyFileInfo ATL_API_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _ATL_API_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _ATL_API_StubVtblList,
    (const PCInterfaceName * ) & _ATL_API_InterfaceNamesList,
    (const IID ** ) & _ATL_API_BaseIIDList,
    & _ATL_API_IID_Lookup, 
    2,
    2,
